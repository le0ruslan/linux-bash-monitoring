...
## About project
The project is dedicated to performing a series of tasks related to system monitoring based on the Linux operating system. As part of the project, Bash scripts are implemented to collect and format system information, analyze the file system, and configure the visual representation of data.
